...
class wrapcauchy(CircularDistribution):
    ...
    def cdf(self, value):
        raise NotImplementedError("The Wrapped Cauchy distribution does not have a closed-form CDF.")

    def icdf(self, value):
        raise NotImplementedError("The Wrapped Cauchy distribution does not have a closed-form quantile function.")
